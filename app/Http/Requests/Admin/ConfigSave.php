...
class ConfigSave extends FormRequest
{
    ...
    public function messages()
    {
        // illiteracy prompt
        return [
            'app_url.url' => 'URL trang web không được định dạng chính xác và phải mang theo http(s)://',
            'subscribe_url.url' => 'URL đăng ký không được định dạng chính xác và phải mang theo http(s)://',
            'server_token.min' => 'Độ dài khóa giao tiếp phải lớn hơn 16 bit',
            'tos_url.url' => 'Điều khoản dịch vụ URL không được định dạng chính xác và phải mang theo http(s)://',
            'telegram_discuss_link.url' => 'Địa chỉ nhóm Telegram phải ở định dạng URL và phải mang theo http(s)://'
        ];
    }
}
